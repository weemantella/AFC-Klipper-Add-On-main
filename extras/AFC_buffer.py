...
class AFCtrigger:
    ...
    def set_multiplier(self, multiplier):
        ...
        if self.debug:
            stepper = cur_stepper.extruder_stepper
    ...
    def reset_multiplier(self):
        ...
        self.gcode.respond_info("Rotation distance reset : {}".format(cur_stepper.extruder_stepper.get_rotation_distance()[0]))
        ...
        if self.printer.state_message == 'Printer is ready' and self.enable:
            ...
            if self.AFC.current != None:
                if state:
                    ...
                    self.set_multiplier( (self.multiplier_low + self.multiplier_low) / 6 )
